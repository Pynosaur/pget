...
from ..utils.paths import get_binary_path, get_doc_dir, get_app_dir, get_temp_cache_dir, ensure_dirs, ensure_path_in_shell
...
class Installer:
    ...
    def uninstall(self, app_name):
        ...
        binary = get_binary_path(app_name)
    ...
    def is_installed(self, app_name):
        ...
        return get_binary_path(app_name).exists()
